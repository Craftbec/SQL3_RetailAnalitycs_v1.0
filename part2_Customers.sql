...
ROUND(Average_Check_Segment.Customer_Average_Check,2) AS Customer_Average_Check,
Average_Check_Segment.Customer_Average_Check_Segment, 
ROUND(Frequency_Segment.Customer_Frequency,2) AS Customer_Frequency,
Frequency_Segment.Customer_Frequency_Segment,
ROUND(Inactive_Period.Customer_Inactive_Period,2) AS  Customer_Inactive_Period,
ROUND(Churn_Segment.Customer_Churn_Rate, 2) AS Customer_Churn_Rate,
